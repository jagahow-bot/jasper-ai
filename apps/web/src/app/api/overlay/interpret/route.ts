...
- asks: when the RM brief has numbered requests (1/2/3…), emit one soft ask object per request (max 12). Each ask:
  ...
  When an ask is an asset-class sleeve (e.g. private funds / 私募基金) and carries tickers that also appear in proposed_tickers, those proposed tickers MUST use the same asset_class (private funds → alternative).
