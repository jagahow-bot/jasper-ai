...
const en: Dict = {
  ...
  "reminders.panel.title": "Reminders",
  "reminders.panel.hint":
    "Auto-created from client needs when a run completes. Visible to you (RM) only — never shown to clients.",
  "reminders.panel.empty": "No reminders yet.",
  "reminders.filter.all": "All",
  "reminders.filter.open": "Open",
  "reminders.filter.done": "Done",
  "reminders.filter.dismissed": "Dismissed",
  "reminders.rule.r1.label": "Need unmet",
  "reminders.rule.r2.label": "Rebalance",
  "reminders.rule.r3.label": "DCA milestone",
  "reminders.rule.r4.label": "Supervisor",
  "reminders.rule.r5.label": "Rerun advised",
  "reminders.rule.r6.label": "Annual review",
  "reminders.rule.r1.title": "Need “{subject}” not met",
  "reminders.rule.r1.detail":
    "{detail} — discuss with client or adjust and rerun",
  "reminders.rule.r1.quotaTitle": "Class quota not effective ({classes})",
  "reminders.rule.r1.quotaDetail":
    "Quota class has no members in the universe; the allocation never happened — add instruments or revise the ask",
  "reminders.rule.r2.title": "Schedule next rebalance review",
  "reminders.rule.r2.detail": "Frequency: {freq} · backtest ends {end}",
  "reminders.rule.r3.title": "DCA tranche {k} of {n}",
  "reminders.rule.r3.detail": "Confirm tranche {k} was deployed as planned",
  "reminders.rule.r4.driftTitle":
    "Customization drift {pct}% exceeds 60% — supervisor approval required",
  "reminders.rule.r4.capabilityTitle":
    "{count} capabilities pending supervisor sign-off",
  "reminders.rule.r5.title": "Performance lags — adjust and rerun advised",
  "reminders.rule.r6.title": "Schedule annual investment review",
  "reminders.rule.r6.detail":
    "One year since inception — review goals and allocation with the client",
  "reminders.action.done": "Mark done",
  ...
  "reminders.status.suggested": "Suggested",
  "reminders.resolvedAuto": "Auto-resolved by the latest run",
  "reminders.banner.created": "{count} reminders created →",
  ...
  "pool.filter.allSellable": "All sellability",
  "pool.filter.sellableOnly": "Sellable only",
  "pool.filter.nonSellableOnly": "Non-sellable only",
  "pool.col.enabled": "On",
  "pool.col.sellable": "Sellable",
  ...
  "pool.toggleSellable": "Toggle sellable for {ticker}",
  "pool.sellableBadge": "{sellable} / {total} sellable",
  "pool.sellable.overridden": "Overridden (default: {value})",
  "pool.bulk.filteredSummary":
    "{count} filtered ({blocked} non-sellable)",
  "pool.bulk.setSellable": "Mark all filtered as sellable",
  "pool.bulk.unsetSellable": "Mark filtered as non-sellable",
  "pool.bulk.resetDefaults": "Reset all to defaults",
  "pool.bulk.resetConfirm":
    "Clear all sellable overrides and restore defaults?",
  "pool.bulk.done": "Updated sellable state for {count} tickers",
  "pool.sellable.diHint":
    "Direct indexing needs individual stocks; stocks are non-sellable by default — filter “Stock” on the pool page and bulk-enable them.",
  "pool.region.us": "US",
...
"overlay.thinking.label": "Jasper 正在分析客戶需求（約需 10–30 秒）…",
  ...
  "reminders.panel.title": "提醒事項",
  "reminders.panel.hint":
    "試算完成時依客戶需求自動建立；僅供 RM 本人檢視，不會對客戶顯示。",
  "reminders.panel.empty": "目前沒有提醒事項。",
  "reminders.filter.all": "全部",
  "reminders.filter.open": "待處理",
  "reminders.filter.done": "已完成",
  "reminders.filter.dismissed": "已忽略",
  "reminders.rule.r1.label": "需求未滿足",
  "reminders.rule.r2.label": "定期再平衡",
  "reminders.rule.r3.label": "分批部署",
  "reminders.rule.r4.label": "主管簽核",
  "reminders.rule.r5.label": "建議重跑",
  "reminders.rule.r6.label": "年度檢視",
  "reminders.rule.r1.title": "需求「{subject}」未達標",
  "reminders.rule.r1.detail": "{detail} — 與客戶溝通或調整後重跑",
  "reminders.rule.r1.quotaTitle": "資產類別配額未生效（{classes}）",
  "reminders.rule.r1.quotaDetail":
    "配額類別在標的池中無成員，需求實際未配置——需補充標的或調整需求",
  "reminders.rule.r2.title": "安排下次再平衡檢視",
  "reminders.rule.r2.detail": "頻率：{freq} · 回測截止 {end}",
  "reminders.rule.r3.title": "分批部署第 {k}/{n} 期",
  "reminders.rule.r3.detail": "確認第 {k} 期資金已依計畫投入",
  "reminders.rule.r4.driftTitle":
    "客製化偏離 {pct}% 超過 60%——需主管核准留痕",
  "reminders.rule.r4.capabilityTitle": "{count} 項能力待主管批次簽核",
  "reminders.rule.r5.title": "表現落後——建議調整後重跑",
  "reminders.rule.r6.title": "安排年度投資檢視",
  "reminders.rule.r6.detail": "承作將滿一年——與客戶檢視目標與配置",
  "reminders.action.done": "標記完成",
  ...
  "reminders.status.suggested": "建議（待確認）",
  "reminders.resolvedAuto": "已由最新試算自動結案",
  "reminders.banner.created": "已建立 {count} 項提醒 →",
  "rm.report.quantTabHint":
...
"goalSim.rulesFallback": "規則推估",
  ...
  "pool.filter.allSellable": "全部（可銷售）",
  "pool.filter.sellableOnly": "僅可銷售",
  "pool.filter.nonSellableOnly": "僅不可銷售",
  "pool.col.enabled": "啟用",
  "pool.col.sellable": "可銷售",
  "pool.col.ticker": "代碼",
  "pool.col.name": "名稱",
  ...
  "pool.toggleSellable": "切換 {ticker} 可銷售",
  "pool.sellableBadge": "可銷售 {sellable} / {total}",
  "pool.sellable.overridden": "已覆寫（預設：{value}）",
  "pool.bulk.filteredSummary":
    "篩選結果 {count} 筆（不可銷售 {blocked}）",
  "pool.bulk.setSellable": "全選篩選結果設為可銷售",
  "pool.bulk.unsetSellable": "批次取消可銷售",
  "pool.bulk.resetDefaults": "回復全部預設",
  "pool.bulk.resetConfirm":
    "確定要清除所有可銷售覆寫並回復預設值？",
  "pool.bulk.done": "已更新 {count} 筆可銷售狀態",
  "pool.sellable.diHint":
    "直接指數化需要個股標的；目前個股預設不可銷售，請至標的池頁篩選「個股」後批次開啟。",
  "pool.region.us": "美國",
  "pool.region.intl": "國際",
...
"overlay.thinking.label":
  ...
  "reminders.panel.title": "알림",
  "reminders.panel.hint":
    "실행 완료 시 고객 니즈에서 자동 생성됩니다. RM 본인에게만 표시되며 고객에게는 보이지 않습니다.",
  "reminders.panel.empty": "알림이 없습니다.",
  "reminders.filter.all": "전체",
  "reminders.filter.open": "처리 대기",
  "reminders.filter.done": "완료",
  "reminders.filter.dismissed": "무시됨",
  "reminders.rule.r1.label": "니즈 미충족",
  "reminders.rule.r2.label": "리밸런싱",
  "reminders.rule.r3.label": "분할 투입",
  "reminders.rule.r4.label": "승인 필요",
  "reminders.rule.r5.label": "재실행 권장",
  "reminders.rule.r6.label": "연간 점검",
  "reminders.rule.r1.title": "니즈 “{subject}” 미달",
  "reminders.rule.r1.detail":
    "{detail} — 고객 상담 또는 조정 후 재실행",
  "reminders.rule.r1.quotaTitle": "자산군 쿼터 미적용({classes})",
  "reminders.rule.r1.quotaDetail":
    "쿼터 자산군에 종목이 없어 실제 배분이 이루어지지 않았습니다 — 종목 보충 또는 니즈 조정 필요",
  "reminders.rule.r2.title": "다음 리밸런싱 점검 예약",
  "reminders.rule.r2.detail": "주기: {freq} · 백테스트 종료 {end}",
  "reminders.rule.r3.title": "분할 투입 {k}/{n}회차",
  "reminders.rule.r3.detail": "{k}회차 자금이 계획대로 투입되었는지 확인",
  "reminders.rule.r4.driftTitle":
    "맞춤화 편차 {pct}%가 60% 초과 — 관리자 승인 필요",
  "reminders.rule.r4.capabilityTitle":
    "{count}개 능력 관리자 승인 대기",
  "reminders.rule.r5.title": "성과 부진 — 조정 후 재실행 권장",
  "reminders.rule.r6.title": "연간 투자 점검 예약",
  "reminders.rule.r6.detail":
    "운용 1년 경과 — 고객과 목표 및 배분 점검",
  "reminders.action.done": "완료 처리",
  ...
  "reminders.status.suggested": "제안됨",
  "reminders.resolvedAuto": "최신 실행으로 자동 해결됨",
  "reminders.banner.created": "알림 {count}개 생성됨 →",
  "rm.report.quantTabHint":
...
"goalSim.rulesFallback": "규칙 기반 추정",
  ...
  "pool.filter.allSellable": "전체(판매가능)",
  "pool.filter.sellableOnly": "판매 가능만",
  "pool.filter.nonSellableOnly": "판매 불가만",
  "pool.col.enabled": "활성",
  "pool.col.sellable": "판매 가능",
  "pool.col.ticker": "티커",
  "pool.col.name": "이름",
  ...
  "pool.toggleSellable": "{ticker} 판매 가능 전환",
  "pool.sellableBadge": "판매 가능 {sellable} / {total}",
  "pool.sellable.overridden": "재정의됨(기본값: {value})",
  "pool.bulk.filteredSummary":
    "필터 결과 {count}개(판매 불가 {blocked})",
  "pool.bulk.setSellable": "필터 결과 전체 판매 가능으로",
  "pool.bulk.unsetSellable": "필터 결과 판매 불가로",
  "pool.bulk.resetDefaults": "모두 기본값으로",
  "pool.bulk.resetConfirm":
    "모든 판매 가능 재정의를 지우고 기본값으로 복원할까요?",
  "pool.bulk.done": "{count}개 종목 판매 가능 상태 변경됨",
  "pool.sellable.diHint":
    "직접 인덱싱에는 개별 주식이 필요합니다. 주식은 기본적으로 판매 불가입니다 — 유니버스 페이지에서 \"주식\"을 필터링하여 일괄 활성화하세요.",
  "pool.region.us": "미국",
  "pool.region.intl": "해외",
