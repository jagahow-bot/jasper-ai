...
const en: Dict = {
  ...
  "goalSim.extractHint": "AI fills the form; you stay in control of numbers.",
  ...
  "goalSim.action.customize":
    "Hand off near-term liquidity and horizon into Overlay customization.",
...
const zh: Dict = {
  ...
  "goalSim.extractHint": "AI 只填表，數字仍由你掌控。",
  ...
  "goalSim.action.customize": "將近端流動性與投資年期帶入 Overlay 客製化。",
...
const ko: Dict = {
  ...
  "goalSim.extractHint": "AI는 양식만 채우며 숫자는 직접 조정합니다.",
  ...
  "goalSim.action.customize": "단기 유동성과 투자기간을 Overlay 맞춤화로 넘기세요.",
