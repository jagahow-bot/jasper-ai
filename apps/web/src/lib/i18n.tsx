...
const en: Dict = {
  ...
  "results.needsTable.groupBandsHint": "Portfolio weight (cash-aware)",
  "results.needsTable.classQuotaHint": "Invested share (ex-cash)",
  "results.needsTable.classQuotaSecondary": "Asset-class quota (secondary)",
  "results.needsTable.classQuotaCollapsed": "Asset-class quotas: all met",
  "results.needsTable.classQuotaExpand": "Show class-quota details",
  "results.needsTable.classQuotaCollapse": "Hide",
  ...
  "rm.report.needsPrimaryBandNote":
    "Named sleeves use band targets as the primary check; class quotas are secondary.",
  ...
  "slides.subtitle": "Slide deck for client meetings — one topic per slide",
  "slides.nav.prev": "Previous",
  "slides.nav.next": "Next",
  "slides.nav.counter": "{current} / {total}",
  "slides.nav.goto": "Go to slide {n}",
  "slides.cover.strategyLineSingle":
    "Recommended customized path: {customized}.",
  "slides.s1.title": "Client & Advisor Overview",
  "slides.s1.account": "Account number",
  "slides.s1.branch": "Institution / Branch",
  "slides.s2.title": "Goals & Portfolio Health Check",
  "slides.s2.targetReturn": "Target annual return",
  "slides.s2.targetReturnNote":
    "Reference: anchor model historical CAGR; not a promise",
  "slides.s2.reference": "ref.",
  "slides.s2.maxDd": "Max acceptable drawdown",
  "slides.s2.drift": "Portfolio drift",
  "slides.s2.concentration": "Concentration check",
  "slides.s2.singleName": "Largest single name",
  "slides.s2.necessity":
    "This rebalance reduces style drift, strengthens downside defense, and locks in gains.",
  "slides.s3.title": "Market Outlook & Strategy",
  "slides.s3.houseView": "House view",
  "slides.s4.title": "Asset Allocation: Current vs. Proposed",
  "slides.s4.current": "Current",
  "slides.s4.proposed": "Proposed",
  "slides.s4.adjustment": "Adjustment",
  "slides.s4.amount": "Proposed amount",
  "slides.s4.class": "Asset class",
  "slides.s4.anchorFootnote":
    "Current column approximates the anchor model mix (no client holdings on file).",
  "slides.s5.title": "Back-testing & Risk Metrics",
  "slides.s5.period": "Backtest window: {start} – {end}",
  "slides.s5.improvement": "Improvement",
  "slides.s6.title": "Stress Test Review",
  "slides.s6.blockA": "Historical Drawdown Review",
  "slides.s6.blockB": "Fixed Scenario Simulation (2008/2020/2022)",
  "slides.s6.honesty":
    "Block A shows actual largest drawdowns within the backtest window; Block B replays fixed historical scenarios (precomputed by the engine). Neither predicts future performance.",
  "slides.s6.defenseDelta": "Defense delta",
  "slides.s6.window": "Window / scenario",
  "slides.s6.scenario.2008": "2008 Global Financial Crisis",
  "slides.s6.scenario.2020": "2020 COVID liquidity shock",
  "slides.s6.scenario.2022": "2022 Rate-hike drawdown",
  "slides.s7.title": "Action Plan: Buy/Sell List",
  "slides.s7.sell": "Redemption list",
  "slides.s7.buy": "Subscription list",
  "slides.s7.isin": "ISIN",
  "slides.s7.rr": "Risk rating",
  "slides.s7.pendingData": "Product data pending",
  "slides.s7.reason": "Rationale",
  "slides.s7.reason.sell": "Style drift; lock in gains",
  "slides.s7.reason.buy": "Raise stable income & defense",
  "slides.s7.none": "No trades required",
  "slides.s8.title": "Estimated Costs & Net Impact",
  "slides.s8.assumption":
    "Illustrative assumption (subscription {subBps} bps / redemption {redBps} bps); actual fees per branch schedule.",
  "slides.s8.totalCost": "One-off transition cost",
  "slides.s8.turnover": "Estimated turnover",
  "slides.s8.feeSplit":
    "Fee assumption: subscription {subBps} bps / redemption {redBps} bps",
  "slides.s8.costPct": "Share of AUM",
  "slides.s8.benefit":
    "Transition cost is weighed against improved risk-adjusted metrics and closer alignment to signed client needs.",
  "slides.s9.title": "Monitoring & Action Triggers",
  "slides.s9.driftAlert":
    "Alert when any asset class drifts beyond ±5% from target.",
  "slides.s9.review":
    "Quarterly / semiannual performance reviews with proactive RM outreach.",
  "slides.s9.event":
    "On threshold breaches, timely defensive guidance is provided.",
  "slides.s10.title": "Compliance, Risk Disclosures & Sign-off",
  "slides.s10.rm": "Relationship Manager",
  "slides.s10.supervisor": "Branch / Compliance Supervisor",
  "slides.s10.client": "Client Acknowledged",
  "slides.s10.ack":
    "I have read and understood the analyses, product features, risks, and estimated fees in this proposal, and agree to execute accordingly.",
  "slides.s10.signatureLine": "Signature / date",
...
const zh: Dict = {
  ...
  "results.needsTable.groupBandsHint": "投組占比（含現金語境）",
  "results.needsTable.classQuotaHint": "已投資占比（不含現金）",
  "results.needsTable.classQuotaSecondary": "資產類別配額（次要）",
  "results.needsTable.classQuotaCollapsed": "資產類別配額：全部達標",
  "results.needsTable.classQuotaExpand": "展開類別配額明細",
  "results.needsTable.classQuotaCollapse": "收合",
...
"overlay.thinking.label": "Jasper 正在分析客戶需求（約需 10–30 秒）…",
  ...
  "slides.subtitle": "面談簡報模式 — 一頁一主題",
  "slides.nav.prev": "上一張",
  "slides.nav.next": "下一張",
  "slides.nav.counter": "{current} / {total}",
  "slides.nav.goto": "前往第 {n} 張",
  "slides.cover.strategyLineSingle": "建議客製化路徑：{customized}。",
  "slides.s1.title": "基本資料",
  "slides.s1.account": "受託帳號",
  "slides.s1.branch": "所屬機構／分行",
  "slides.s2.title": "理財目標與現況診斷",
  "slides.s2.targetReturn": "預期目標年化報酬",
  "slides.s2.targetReturnNote":
    "參考值：anchor 模型歷史年化報酬，非承諾績效",
  "slides.s2.reference": "參考",
  "slides.s2.maxDd": "容許最大下檔風險",
  "slides.s2.drift": "資產偏離度",
  "slides.s2.concentration": "風險集中度診斷",
  "slides.s2.singleName": "最大單一標的",
  "slides.s2.necessity":
    "透過本次再平衡，降低資產風格偏離，強化下檔防禦力並鎖定收益。",
  "slides.s3.title": "市場總經展望與配置方針",
  "slides.s3.houseView": "總體經濟觀點",
  "slides.s4.title": "資產配置架構對比",
  "slides.s4.current": "現有投資組合",
  "slides.s4.proposed": "建議新投資組合",
  "slides.s4.adjustment": "權重增減",
  "slides.s4.amount": "建議配置金額",
  "slides.s4.class": "資產類別",
  "slides.s4.anchorFootnote":
    "現有欄以 anchor 模型持股近似（客戶尚無持股資料）。",
  "slides.s5.title": "量化回測與風險效益分析",
  "slides.s5.period": "回測區間：{start} 至 {end}",
  "slides.s5.improvement": "改善效益",
  "slides.s6.title": "壓力測試",
  "slides.s6.blockA": "歷史最大回撤回顧",
  "slides.s6.blockB": "固定情境模擬（2008／2020／2022）",
  "slides.s6.honesty":
    "A 區為回測區間內實際最大回撤事件；B 區為固定歷史情境重播（引擎預計算），兩者皆非未來績效預測。",
  "slides.s6.defenseDelta": "防禦差異",
  "slides.s6.window": "期間／情境",
  "slides.s6.scenario.2008": "2008 金融海嘯",
  "slides.s6.scenario.2020": "2020 疫情流動性",
  "slides.s6.scenario.2022": "2022 升息雙殺",
  "slides.s7.title": "再平衡調倉明細",
  "slides.s7.sell": "建議賣出／贖回清單",
  "slides.s7.buy": "建議買入／新增配置清單",
  "slides.s7.isin": "代碼 (ISIN)",
  "slides.s7.rr": "風險等級",
  "slides.s7.pendingData": "待串接產品資料",
  "slides.s7.reason": "調整原因",
  "slides.s7.reason.sell": "風格漂移，鎖定獲利",
  "slides.s7.reason.buy": "提高穩定配息與防禦",
  "slides.s7.none": "無需調倉",
  "slides.s8.title": "交易成本預估與效益",
  "slides.s8.assumption":
    "本頁為試算假設（申購 {subBps} bps／贖回 {redBps} bps），實際費率以分行公告為準。",
  "slides.s8.totalCost": "預計一次性總換倉成本",
  "slides.s8.turnover": "預估週轉率",
  "slides.s8.feeSplit": "費率假設：申購 {subBps} bps／贖回 {redBps} bps",
  "slides.s8.costPct": "佔 AUM 比例",
  "slides.s8.benefit":
    "換倉成本需與風險調整後指標改善、以及更贴近簽核需求一併衡量。",
  "slides.s9.title": "動態監控機制與服務承諾",
  "slides.s9.driftAlert":
    "任一大類資產權重偏離目標超過 ±5% 時，系統主動發出再平衡檢視提示。",
  "slides.s9.review":
    "每季／每半年固定寄發投組表現追蹤報告，並由理財顧問主動聯繫討論。",
  "slides.s9.event":
    "市場波動超越預設風控門檻時，第一時間提供應對指引與防禦建議。",
  "slides.s10.title": "法規風險揭露與簽章覆核",
  "slides.s10.rm": "理財顧問 (RM)",
  "slides.s10.supervisor": "分行／合規主管",
  "slides.s10.client": "客戶確認簽署",
  "slides.s10.ack":
    "本人已詳閱並充分理解本建議書之各項分析內容、標的特性、潛在風險及預估費用，並同意依上述規劃指示執行後續交易。",
  "slides.s10.signatureLine": "簽署／日期",
  "slides.placeholder.dash": "—",
...
const ko: Dict = {
  ...
  "results.needsTable.groupBandsHint": "포트폴리오 비중（현금 포함 맥락）",
  "results.needsTable.classQuotaHint": "투자 비중（현금 제외）",
  "results.needsTable.classQuotaSecondary": "자산군 한도（보조）",
  "results.needsTable.classQuotaCollapsed": "자산군 한도: 모두 충족",
  "results.needsTable.classQuotaExpand": "자산군 한도 상세 보기",
  "results.needsTable.classQuotaCollapse": "접기",
...
"overlay.thinking.label":
  ...
  "rm.report.needsPrimaryBandNote":
    "지정 슬리브는 밴드 목표가 기본이며, 자산군 한도는 보조 점검입니다.",
  ...
  "slides.subtitle": "고객 미팅용 슬라이드 — 슬라이드당 하나의 주제",
  "slides.nav.prev": "이전",
  "slides.nav.next": "다음",
  "slides.nav.counter": "{current} / {total}",
  "slides.nav.goto": "{n}번 슬라이드로 이동",
  "slides.cover.strategyLineSingle": "권장 맞춤 경로: {customized}.",
  "slides.s1.title": "기본 정보",
  "slides.s1.account": "수탁 계좌",
  "slides.s1.branch": "소속 기관/지점",
  "slides.s2.title": "투자 목표 및 현황 진단",
  "slides.s2.targetReturn": "목표 연수익률",
  "slides.s2.targetReturnNote":
    "참고값: 앵커 모델 과거 연수익률(약정 아님)",
  "slides.s2.reference": "참고",
  "slides.s2.maxDd": "허용 최대 낙폭",
  "slides.s2.drift": "자산 이탈도",
  "slides.s2.concentration": "집중도 진단",
  "slides.s2.singleName": "최대 단일 종목",
  "slides.s2.necessity":
    "이번 리밸런싱으로 스타일 이탈을 줄이고 하방 방어를 강화합니다.",
  "slides.s3.title": "시장 전망 및 배분 방침",
  "slides.s3.houseView": "하우스 뷰",
  "slides.s4.title": "자산배분 비교",
  "slides.s4.current": "현재",
  "slides.s4.proposed": "제안",
  "slides.s4.adjustment": "조정",
  "slides.s4.amount": "제안 금액",
  "slides.s4.class": "자산군",
  "slides.s4.anchorFootnote":
    "현재 열은 앵커 모델 비중 근사치입니다(고객 보유 데이터 없음).",
  "slides.s5.title": "백테스트 및 리스크 지표",
  "slides.s5.period": "백테스트 구간: {start}~{end}",
  "slides.s5.improvement": "개선 효과",
  "slides.s6.title": "스트레스 테스트",
  "slides.s6.blockA": "과거 최대 낙폭 검토",
  "slides.s6.blockB": "고정 시나리오 시뮬레이션(2008/2020/2022)",
  "slides.s6.honesty":
    "A는 백테스트 구간 내 실제 최대 낙폭, B는 고정 역사 시나리오 재현(엔진 사전 계산)이며 미래 성과 예측이 아닙니다.",
  "slides.s6.defenseDelta": "방어 차이",
  "slides.s6.window": "구간/시나리오",
  "slides.s6.scenario.2008": "2008 금융위기",
  "slides.s6.scenario.2020": "2020 코로나 유동성",
  "slides.s6.scenario.2022": "2022 금리인상 조정",
  "slides.s7.title": "리밸런싱 매매 내역",
  "slides.s7.sell": "매도/환매 목록",
  "slides.s7.buy": "매수/신규 편입 목록",
  "slides.s7.isin": "ISIN",
  "slides.s7.rr": "위험 등급",
  "slides.s7.pendingData": "상품 데이터 연동 예정",
  "slides.s7.reason": "사유",
  "slides.s7.reason.sell": "스타일 이탈, 이익 확정",
  "slides.s7.reason.buy": "안정 인컴·방어 강화",
  "slides.s7.none": "조정 불필요",
  "slides.s8.title": "거래 비용 추정",
  "slides.s8.assumption":
    "예시 가정(신규 {subBps}bps/환매 {redBps}bps)이며 실제 수수료는 지점 기준입니다.",
  "slides.s8.totalCost": "일회성 교체 비용",
  "slides.s8.turnover": "추정 회전율",
  "slides.s8.feeSplit": "수수료 가정: 신규 {subBps}bps / 환매 {redBps}bps",
  "slides.s8.costPct": "AUM 대비",
  "slides.s8.benefit":
    "전환 비용은 위험조정 성과 개선 및 서명된 니즈 정렬과 함께 평가합니다.",
  "slides.s9.title": "모니터링 및 서비스 약속",
  "slides.s9.driftAlert":
    "자산군 비중이 목표 대비 ±5% 초과 이탈 시 알림.",
  "slides.s9.review": "분기/반기 성과 보고 및 RM 선제 연락.",
  "slides.s9.event": "변동성 임계 초과 시 방어 가이드 제공.",
  "slides.s10.title": "규제 고지 및 서명",
  "slides.s10.rm": "RM",
  "slides.s10.supervisor": "지점/준법 책임자",
  "slides.s10.client": "고객 서명 확인",
  "slides.s10.ack":
    "본 제안서의 분석, 상품 특성, 위험 및 예상 비용을 충분히 이해하였으며 이에 동의합니다.",
  "slides.s10.signatureLine": "서명 / 날짜",
  "slides.placeholder.dash": "—",
