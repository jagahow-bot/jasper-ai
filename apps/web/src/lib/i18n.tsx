...
const en: Dict = {
  ...
  "clients.launchHint": "Opens Portfolio Customization with this client’s risk profile and suggested anchor prefilled.",
...
const zh: Dict = {
  ...
  "clients.launchHint": "將帶入此客戶風險屬性與建議錨點，進入投資組合客製化流程。",
...
const ko: Dict = {
  ...
  "clients.launchHint": "이 고객의 위험성향과 권장 앵커를 반영해 포트폴리오 맞춤화로 이동합니다.",
