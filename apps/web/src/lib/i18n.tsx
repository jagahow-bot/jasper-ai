...
const en: Dict = {
  ...
  "header.apiLinked": "Backtest API connected",
  "lang.label": "LANG",
  "lang.aria": "Language",
  ...
  "config.control.max_holdings_actual": "Max holdings (actual)",
  ...
  "rm.report.talkingTitle": "Backtest summary",
  ...
  "rm.report.candidateLabel": "Backtested portfolio",
...
const zh: Dict = {
  ...
  "config.control.max_holdings_actual": "最大持倉數（實際）",
...
const ko: Dict = {
  ...
  "config.control.max_holdings_actual": "최대 보유 종목(실제)",
  ...
  "rm.report.talkingTitle": "백테스트 요약",
  ...
  "rm.report.candidateLabel": "백테스트 포트폴리오",
  "rm.report.candidateChampion": "★",
